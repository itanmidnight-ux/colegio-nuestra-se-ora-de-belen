  ...
  <main class="public-content" id="main-content">
    ...
    <section class="main-periodico-display">
      ...
      <div class="pdf-container">
        <iframe src="../uploads/<?php echo htmlspecialchars($periodico_principal['archivo_pdf']); ?>#toolbar=1&navpanes=0&view=FitH" title="Visor completo del periódico" frameborder="0"></iframe>
      </div>
    </section>
